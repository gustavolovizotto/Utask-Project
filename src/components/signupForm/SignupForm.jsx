...
export function SignUpForm({ isDarkMode }) {
    ...
    const handleChange = (e) => {
        ...
        if (name === 'senha' || name === 'confirmarSenha') {
            ...
            const confirmar = name === 'confirmarSenha' ? value : formData.confirmarSenha;
        ...
        try {
            ...
            toast.success(
                <div className={styles.toastContent}>
                    ...
                    <p className={styles.toastMessage}>Redirecionando para a página principal...</p>
                </div>, 
                {
                    position: "top-center",
                    autoClose: 3000,
        ...
        <>
            ...
            >
                ...
                <div className={styles.senha_wrapper}>
                    ...
                    <label className={styles.label} htmlFor="nome">Nome de usuário</label>
                    <input
                ...
                <div className={styles.senha_wrapper}>
                    <label className={styles.label} htmlFor="confirmarSenha">Confirme a senha</label>
                    <input
                        className={`${styles.input} ${senhaError ? styles.inputError : ''}`}
                        type={mostrarSenha ? 'text' : 'password'}
                        id="confirmarSenha"
                    ...
                    />
                    {senhaError && (
                        <span className={styles.errorMessage}>Senhas não combinam, tente novamente</span>
                    )}
                </div>
